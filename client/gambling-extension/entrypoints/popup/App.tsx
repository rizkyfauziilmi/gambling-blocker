    ...
    <div className="w-90 bg-linear-to-b from-white to-gray-50 p-4">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-gray-500 text-xs">{t("popup_protectionActive")}</p>
        </div>
      </div>

      <div className="bg-gray-50 border border-gray-200 rounded-xl p-3 mb-3">
        <p className="text-xs text-gray-500 mb-1">{t("popup_currentTab")}</p>
        <p className="text-sm text-gray-700 truncate">{tabUrl || "—"}</p>
      </div>
      ...
      {status === "error" && (
        <div className="bg-red-50 border border-red-200 rounded-xl p-4 text-center">
          <p className="text-red-700 text-sm">{t("popup_failedToScan")}</p>
        </div>
      )}
      ...
      {status === "bare-ip" && (
        <div className="bg-gray-100 border border-gray-300 rounded-xl p-4 text-center">
          ...
          <p className="text-gray-500 text-xs mt-1">{t("popup_bareIpDesc")}</p>
        </div>
      )}
